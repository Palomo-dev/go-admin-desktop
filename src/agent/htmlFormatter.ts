...
// - html y body tienen width: 80mm explícito para garantizar que el contenido
//   se renderice al ancho correcto independientemente del driver de Windows.
const SHARED_CSS = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  @page { margin: 0; }
  html, body { -webkit-print-color-adjust: exact; print-color-adjust: exact; width: 80mm; }
  body {
    margin: 0;
